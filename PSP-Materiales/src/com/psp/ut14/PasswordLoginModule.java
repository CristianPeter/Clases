...
public class PasswordLoginModule implements LoginModule {
     ...
     * Inicializar.
     */
    public void initialize(Subject sujeto, CallbackHandler callbackHandler, Map estadoCompartido, Map opciones) {
        mSujeto = sujeto;
